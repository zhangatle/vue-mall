  ...
  <div class="wrapper">
    <div class="container clearfix">
      ...
      <div class="content">
        ...
        <p class="item-info">相机全新升级 / 960帧超慢动作 / 手持超级夜景 / 全球首款双频GPS / 骁龙845处理器 / 红<br/>外人脸解锁 / AI变焦双摄 / 三星AMOLED屏幕</p>
        ...
        <div class="item-version clearfix">
          ...
          <div class="phone fr" :class="{'checked':version==2}" @click="version=1">4GB+64GB 移动4G</div>
        </div>
