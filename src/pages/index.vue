    ...
    <div class="container">
      ...
      <div class="wrapper">
        <div class="banner-left">
          <a href="/#/product/35"><img v-lazy="'/images/mix-alpha.jpg'" alt=""></a>
        </div>
        <div class="list-box">
          ...
          .item{
            ...
            .item-info{
              ...
              .price{
                ...
                cursor: pointer;
                &:after{
                  @include bgImg(22px, 22px, "/images/icon-ccart-hover.png");
                  content: " ";
                  margin-left: 5px;
                  vertical-align: middle;
                }
